...
import 'package:health_stats_ui/screens/agent_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Widget> pages = [
      _buildHomeView(devicWidth, devicHeight),
  ...
  Widget _buildHomeView(double devicWidth, double devicHeight) {
    return Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Text('Velix', style: AppFonts.semiBold.copyWith(fontSize: 20)),
                Row(
                  children: [
                    Container(
                      width: 40,
